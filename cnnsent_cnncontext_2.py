...
"""
    context encoder: CNNencoder, CNN as combination
...
for window in [2,3,4,5]:
    tmp = Conv2D(filters=nfilters, kernel_size=(window, K.int_shape(sent_att_vecs_dr)[-1]), data_format='channels_first')(sent_att_vecs_dr)  # (batch_size, #filters, 6-window+1, 1)
