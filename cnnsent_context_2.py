...
"""
    context encoder: CNNencoder, mean as combination
...
checkpointer = ModelCheckpoint(filepath=path_to_data + 'model_cnn_context_' + str(tgt), 
                                verbose=1, 
                                save_best_only=True,
...
if save_history:
    with open(path_to_data + 'model_history_cnn_context_' + str(tgt) + '.json', 'w') as file:
