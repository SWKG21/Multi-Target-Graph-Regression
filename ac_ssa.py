...
"""
    ...
    sentence encoder for u: StructuredSelfAttentive; add SkipConnection;
...
sent_wa = bidir_gru(sent_wa, sent_n_units, is_GPU)
...
u_sent_wa = bidir_lstm(u_sent_wa, u_n_units, is_GPU)
