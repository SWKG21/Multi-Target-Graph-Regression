...
"""
    replace u in sentence encoder and document encoder;
    sentence encoder: SelfAttention; add SkipConnection;
    document encoder: SelfAttention; add SkipConnection;
...
sent_att_vec = SelfAttention()(sent_wa)
...
doc_att_vec = SelfAttention()(doc_sa)
