...
"""
    sentence encoder: StrcuturedSelfAttentive (first m in file name), add SkipConnection
    document encoder: AttentionWithMultiContext, StrcuturedSelfAttentive (second m in file name) for u
"""
